...
/// ```no_run
/// # fn main() -> eyre::Result<()> {
/// cli_xtask::archive::create("foo.tar.gz", "./foo/")?;
/// cli_xtask::archive::create("bar.tar.gz", "./bar.txt")?;
/// # Ok(())
/// # }
/// ```
#[tracing::instrument(name = "archive::create", skip_all, err)]
pub fn create(archive_path: impl AsRef<Utf8Path>, src: impl AsRef<Utf8Path>) -> eyre::Result<()> {
